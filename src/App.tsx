...
function App() {
  ...
  return (
    <>
      <div
        id="background"
        className=" min-h-screen bg-orange-400 grid justify-items-center mx-auto"
      >
        ...
        <div className="w-10/12">
          ...
          <div>
            <button
              onClick={AskService}
              className="bg-slate-300 rounded px-2 mt-1"
            >
              Enviar
            </button>
          </div>
          ...
          <div className=" grid justify-items-center">
            <div className="flex">
              ...
              <button
                ...
                onClick={GeraAudio}
                className="bg-blue-500 m-1 disabled:opacity-50"
              >
